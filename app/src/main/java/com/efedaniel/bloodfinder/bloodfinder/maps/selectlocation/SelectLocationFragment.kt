...
//            Places.initialize(mainActivity.applicationContext, Secret.BILLING_API_KEY)
            Places.initialize(mainActivity.applicationContext, "U4r1a4rJ7OidtMCAj8xTXWu5AKw=")
        ...
        viewModel.locationSavedAction.observe(viewLifecycleOwner, Observer {
            if (it) {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        // Add a marker in Srilanaka and move the camera
        val srilanka = LatLng(7.251792842987145, 80.44619677603019)
